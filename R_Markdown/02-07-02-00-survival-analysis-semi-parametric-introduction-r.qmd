...
[![](Image/github_Python.png){width=220 fig-alt="GitHub Python notebook"}](https://github.com/zia207/Survival_Analysis_R/blob/main/Colab_Notebook/02_07_02_00_survival_analysis_semi_parametric_introduction_r.ipynb)
</div>
:::
...
Here are **five short, focused resources** on **semi-parametric survival analysis** (mainly the Cox model):

1. **Therneau & Grambsch — *Modeling Survival Data: Extending the Cox Model***
   The classic reference for Cox PH and extensions.

2. **Klein & Moeschberger — *Survival Analysis***
   Clear explanation of partial likelihood and semi-parametric inference.

3. **Andersen et al. — *Statistical Models Based on Counting Processes***
   The mathematical foundation for semi-parametric Cox modeling.

4. **Collett — *Modelling Survival Data in Medical Research***
   Practical applied guide to Cox modeling and diagnostics.

5. **Hosmer, Lemeshow & May — *Applied Survival Analysis***
   Beginner-friendly treatment of semi-parametric survival models.
