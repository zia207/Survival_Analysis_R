...
[![](Image/github_Python.png){fig-align="right" width="200"}](https://github.com/zia207/Survival_Analysis_Python/tree/main/Notebook//02_07_07_05_03_survival_analysis_deep_survival_gpu_python.ipynb)
:::
...
- ✅ **Automatic GPU acceleration** via `torch_device("cuda")`  
- 🔄 **Seamless CPU fallback** if CUDA is unavailable  
- 📈 **All plotting/evaluation** uses CPU tensors (required for R compatibility)  
- ⚡ **Training is faster on GPU**, especially with larger datasets or architectures  

> 💡 **For large-scale environmental datasets** (e.g., pyrogenic carbon prediction), this CUDA support enables **scalable, spatially explicit survival modeling** on GPU clusters—aligning with your HPC workflow.
